        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body mrg_bottom">
                    <form action="{{ route('category.update') }}" method="post" class="form form-horizontal"
                            ...
                            <div class="section-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="category_name" id="category_name" class="form-control" value="{{ $edit->name }}"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fileupload_block">
                                            <input type="file" name="category_icon" id="fileupload" onchange="readURLIcone(this);">
                                            <div class="fileupload_img">
                                                <img type="image" id="category_icone"
                                                     src="{{ $edit->icon_path ? asset('Category/icon_image/' . $edit->icon_path) : asset('admin/images/series-cover.jpg') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fileupload_block">
                                            ...
                                            <div class="fileupload_img">
                                                <img type="image" src="{{ asset('Category/background_image/' . $edit->background_image_path) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="color" name="category_bg_color" id="category_bg_color" value="{{ $edit->background_color }}" required
